...
local ChangeLogData = {
	...
	"Changes:",
		--"• ",
		"• Update Aurora",
		"• Update debuffs for groups",
		"• Update missions datatext",
		"• Update aura display",
		"• Update Eye of the Jailer bar",
		"• Added chat history [by Rav99]",
		"• Added seperat Renown-Display on gold datatext [by Rav99]",
		"• Added Emojis to chat [by Rav99]",
		"• Added display for Eye of the Jailer as bar [by Rav99]",
		"• Fixed different issue",
		"• Optimzed code and functions",
	" ",
	"Important:",
