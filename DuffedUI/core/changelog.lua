...
local ChangeLogData = {
	...
	"Changes:",
		--"• ",
		"• Update Aurora",
		"• Added Torghast-Info to time datatext [by Rav99]",
		"• Added spell to classfilter and cooldowns",
		"• Update debuff filter for raids",
		"• Fixed panel positions if rightbar is vertical",
	" ",
	"Important:",
